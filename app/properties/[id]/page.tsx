            ...
            <div className="">
                ...
                <div className="mx-autoxxx mt-6 max-w-2xl sm:px-6 grid gap-x-4 grid-cols-5 grid lg:grid lg:max-w-7xl lg:grid-cols-5 lg:gap-x-6 lg:px-8">
                    <div className="col-span-2 aspect-h-4 aspect-w-4 hiddenxxx overflow-hidden rounded-lg lg:block">
                        <img src={nftJson.images[0]} alt={nftJson.images[0]} className="h-full w-full object-cover object-center" />
                    </div>
                    <div className="hiddenxxx grid lg:grid lg:grid-cols-1 gap-y-4 lg:gap-y-6">
                        <div className="aspect-h-2 aspect-w-2 overflow-hidden rounded-lg">
                            <img src={nftJson.images[1]} alt={nftJson.images[1]} className="h-full w-full object-cover object-center" />
                        </div>
                        <div className="aspect-h-2 aspect-w-2 overflow-hidden rounded-lg">
                            <img src={nftJson.images[2]} alt={nftJson.images[2]} className="h-full w-full object-cover object-center" />
                        </div>
                    </div>
                    <div className="hiddenxxx grid lg:grid lg:grid-cols-1 gap-y-4 lg:gap-y-6">
                        <div className="aspect-h-2 aspect-w-2 overflow-hidden rounded-lg">
                            <img src={nftJson.images[3]} alt={nftJson.images[3]} className="h-full w-full object-cover object-center" />
                        </div>
                        <div className="aspect-h-2 aspect-w-2 overflow-hidden rounded-lg">
                            <img src={nftJson.images[4]} alt={nftJson.images[4]} className="h-full w-full object-cover object-center" />
                        </div>
                    </div>
                    <div className="hiddenxxx grid lg:grid lg:grid-cols-1 gap-y-4 lg:gap-y-6">
                        <div className="aspect-h-2 aspect-w-2 overflow-hidden rounded-lg">
                            <img src={nftJson.images[5]} alt={nftJson.images[5]} className="h-full w-full object-cover object-center" />
                        </div>
                        <div className="aspect-h-2 aspect-w-2 overflow-hidden rounded-lg">
                            <img src={nftJson?.images[6]} alt={nftJson?.images[6]} className="h-full w-full object-cover object-center" />
                        </div>
                    </div>
                </div>
                {/* Product info */}
                <div className="mx-autoxxx max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
                    <div className="lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8">
                        <h1 className="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">{nftJson.disposition + " in " + nftJson.building + ", " + nftJson.community + ", Dubai"}</h1>
                    </div>
                    {/* Options */}
                    <div className="mt-4 lg:row-span-3 lg:mt-0">
                        <h2 className="sr-only">Product information</h2>
                        <p className="text-3xl tracking-tight text-gray-900">{currencyformatter.format(nftJson.price)}</p>
